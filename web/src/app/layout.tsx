...
const TITLE = "Payrail";
const DESCRIPTION =
  "Create a USDG invoice on Robinhood Chain, send a payment link, and let the onchain payment be matched to the right invoice. Automatic, with no funds ever held.";
