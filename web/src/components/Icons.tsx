...
export function ChevronIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" aria-hidden="true" className={className}>
      <path d="M6 4 L10 8 L6 12" stroke="#6e6e6e" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function LinkIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className={className}>
      ...
      <path d="M7 13 5.6 14.4a2.8 2.8 0 0 1-4-4L4.4 7.6a2.8 2.8 0 0 1 4 0" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M13 7l1.4-1.4a2.8 2.8 0 0 1 4 4L15.6 12.4a2.8 2.8 0 0 1-4 0" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
...
export function ReceiptIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className={className}>
      <path d="M5 2.5h10v15l-2.5-1.5L10 17.5l-2.5-1.5L5 17.5z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <path d="M7.5 7h5M7.5 10h5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
