      ...
      <header className="sticky top-0 z-20 border-b border-line bg-bg/85 backdrop-blur">
        <div className="mx-auto flex h-[68px] w-full max-w-[1180px] items-center justify-between px-5 sm:px-8">
          ...
          <nav className="flex items-center gap-1">
            ...
            <Link
              href={LINKS.app}
              className="rounded-full bg-ink px-4 py-2 text-[14px] font-semibold whitespace-nowrap text-bg transition-colors hover:bg-green-accent sm:ml-1.5"
            >
              Open dashboard
            </Link>
          </nav>
      ...
      <footer className="mt-24 border-t border-line">
        <div className="mx-auto flex w-full max-w-[1180px] flex-col gap-4 px-5 py-10 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          <p className="max-w-md text-[13px] text-ink-faint">
            ...
            merchant. Not audited; running on a test network.
          </p>
          <nav className="flex flex-wrap gap-5 text-[13.5px] text-ink-soft">
            ...
            <Link href={LINKS.whitepaper} className="hover:text-ink">
              Whitepaper
            </Link>
...
/** Sticky table of contents built from a document headings. */
