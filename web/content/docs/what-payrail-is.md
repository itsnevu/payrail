...
It is not a payment gateway and not a custodian: we never hold your USDC and cannot reverse a transaction. It is not a full invoicing suite; there are no taxes, discounts or partial payments yet. It is not audited, and it runs on a test network. See [Risks and limits](/docs/risks-and-limits).
